...
class DQN(nn.Module):
    ...
    def __init__(self, n_observations, n_actions):
        ...
        self.layer1 = nn.Linear(n_observations, 512) #input layer, takes in n observations about the state -> feeds into layer with 128 neurons
        self.layer2 = nn.Linear(512, 512) #hidden layer
        self.layer3 = nn.Linear(512, n_actions) #output layer

    # Called with either one element to determine next action, or a batch
    # during optimization. Returns tensor([[left0exp,right0exp, up0exp, down0exp]...]).
    def forward(self, x):
